...
var marked = __webpack_require__(/*! marked */ "./node_modules/simplemde/node_modules/marked/lib/marked.js");
...
var _config = __webpack_require__(/*! ./config */ "./src/client/js/config.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var deletePost = function deletePost(id) {
  debugger;
  return _axios2.default.delete(_config.API_BASE + '/phase/' + id, {
    headers: { 'Content-type': 'application/json' },
    data: null // data null is necessary to pass the headers
  }).then(function () {
    return window.location.assign('/admin?cache=false');
  }).catch(function (error) {
    window.location.assign('/admin?cache=false');
  });
};

var setupDeletePostHandler = function setupDeletePostHandler() {
  var links = Array.prototype.slice.call(document.querySelectorAll('.delete-post'), 0);
...
var initMarkdownEditor = function initMarkdownEditor() {
  new _simplemde2.default();
};

var initImageUpload = function initImageUpload() {
...
var setupSubmitHandler = function setupSubmitHandler() {
  var btns = Array.prototype.slice.call(document.querySelectorAll('.button-submit'));
  btns.forEach(function (btn) {
    return btn.addEventListener('click', function () {
      return btn.classList.add('is-loading');
    });
  });
};

var pageReady = function pageReady(page) {
  switch (page) {
    case 'admin-index':
...
var blogPostId = void 0;
var nextPage = void 0;
var commentFormEl = void 0;
var commentsEl = void 0;
var commentFormErrorsEl = void 0;

var deleteComment = function deleteComment(e) {
  var id = parseInt(e.currentTarget.dataset.commentId, 10);
  return _axios2.default.delete(_config.API_BASE + '/comments/' + id).then(function () {
...
var loadComments = function loadComments(id) {
  var uri = _config.API_BASE + '/blog/' + id + '/comments';
  if (nextPage) {
    uri += '?start=' + nextPage;
  }
  return _axios2.default.get(uri).then(function (response) {
    if (response.data.entities) {
      response.data.entities.forEach(function (comment) {
        var commentEl = createCommentElementFromEntity(comment);
...
var submitComment = function submitComment(e, id) {
  e.preventDefault();

  commentFormErrorsEl.classList.add('is-hidden');

  var name = e.target.elements[0].value;
  var website = e.target.elements[1].value || null;
  var comment = e.target.elements[2].value;
  ...
  return _axios2.default.post(_config.API_BASE + '/blog/' + blogPostId + '/comments', postData).then(function (response) {
    var commentEl = createCommentElementFromEntity(response.data);
    commentsEl.insertBefore(commentEl, commentsEl.firstChild);
    commentFormEl.reset();
  }).catch(function (res) {
    var error = res.response.data;
    var message = void 0;
    if (error.name == 'ValidationError') {
      message = error.details.reduce(function (acc, err) {
        acc += err.message + '<br>';
        return acc;
      }, '');
    } else {
...
var createCommentElementFromEntity = function createCommentElementFromEntity(entity) {
  var id = entity.id,
      createdOnFormatted = entity.createdOnFormatted,
      comment = entity.comment,
      name = entity.name,
      website = entity.website;


  var nameRendered = website ? '<a href="' + website + '" class="tag" target="_blank">' + name + '</a>' : name;
...
var pageReady = function pageReady(pageId) {
  if (pageId === 'blogpost-view') {
    ...
    var buttonsDeleteComments = Array.prototype.slice.apply(document.querySelectorAll('.comment .delete'));
    buttonsDeleteComments.forEach(function (el) {
      return el.addEventListener('click', deleteComment);
    });

    var btnLoadMore = document.getElementById('load-more-comments');
    if (btnLoadMore) {
      btnLoadMore.addEventListener('click', function () {
        return loadComments(blogPostId);
      });
    }
...
exports.default = { pageReady: pageReady };
...
var _blog = __webpack_require__(/*! ./blog */ "./src/client/js/blog.js");

var _blog2 = _interopRequireDefault(_blog);

var _comment = __webpack_require__(/*! ./comment */ "./src/client/js/comment.js");
...
(0, _es6Docready2.default)(function () {
  _blog2.default.pageReady(window.pageId);
  _comment2.default.pageReady(window.pageId);
});
...
/******/ });
//# sourceMappingURL=main.4cad0e028bd7bbe4462f.js.map